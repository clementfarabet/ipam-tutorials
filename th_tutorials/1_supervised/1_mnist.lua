...
--
-- Note: The script is quite verbose, on purpose. Instead of
-- relying on opaque classes, dataset creation, as well as the
-- complete training loop are basically exposed right here.
--
-- Clement Farabet
----------------------------------------------------------------------
